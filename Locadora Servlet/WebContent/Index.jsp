...
<html lang="en">
  ...
  <body>
   <div class="container" style="margin-top: 250px; margin-left: 400px;">
    ...
    <a href="CadastroCarro.jsp"> <button type="button" class="btn btn-secondary">Cadastrar Carro</button></a>
    <a href="AlteraCarro.jsp"> <button type="button" class="btn btn-secondary">Alterar Carro</button></a>
    <a href="CarroMostrar.jsp"> <button type="button" class="btn btn-secondary">Visualizar Carros</button></a>
    <a href="Locacao.jsp"> <button type="button" class="btn btn-secondary">Locação</button></a>
